  ...
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img 
          src="https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" 
          alt="People on wildlife safari tour"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-black/40"></div>
        <div className="absolute inset-0 bg-gradient-to-br from-nature-sky-300/20 via-nature-blue-200/20 to-nature-green-100/20"></div>
      </div>
      
      {/* Animated background elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-10 animate-float">
          <Plane className="h-12 w-12 text-white opacity-30" />
        </div>
        <div className="absolute top-40 right-20 animate-float" style={{ animationDelay: '1s' }}>
          <TreePalm className="h-16 w-16 text-white opacity-30" />
        </div>
        <div className="absolute bottom-40 left-20 animate-float" style={{ animationDelay: '2s' }}>
          <Map className="h-10 w-10 text-white opacity-30" />
        </div>
      </div>
      ...
      <div className="absolute top-1/4 right-10">
        <div className="relative">
          <Plane className="h-24 w-24 text-white opacity-40 animate-float" />
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <div className="animate-slide-in">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 drop-shadow-2xl">
            TSM
            <span className="block text-3xl md:text-4xl text-nature-green-200 mt-2 drop-shadow-xl">
              TOURS & TRAVEL
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button 
              size="lg" 
              variant="outline" 
              className="border-2 border-white text-white hover:bg-white hover:text-nature-blue-600 px-8 py-4 text-lg rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 backdrop-blur-sm bg-white/10"
            >
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white/20 backdrop-blur-sm rounded-xl p-6 text-white border border-white/20">
